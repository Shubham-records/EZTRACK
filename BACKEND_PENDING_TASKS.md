...
| **SCH-REC-05**| **Generated Columns** | Convert `computed_status` to a PostgreSQL `STORED` generated column. This allows native SQL indexing for "Active" member queries. | High |
